        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card border-0 shadow-sm rounded">
                    <div class="card-body">
                        <form action="{{ route('penjualans.update', $penjualan->id_penjualan) }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('id_penjualan') is-invalid @enderror" name="id_penjualan" value="{{ old('id_penjualan', $penjualan->id_penjualan) }}" readonly>
                                @error('id_penjualan')
                            ...
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control @error('tanggal_penjualan') is-invalid @enderror" name="tanggal_penjualan" value="{{ old('tanggal_penjualan', $penjualan->tanggal_penjualan) }}">
                                @error('tanggal_penjualan')
                                    <div class="alert alert-danger mt-2">{{ $message }}</div>
                                @enderror
                            </div>

                            <!-- TOTAL HARGA (Format seperti pada create.blade.php) -->
                            <div class="form-group">
